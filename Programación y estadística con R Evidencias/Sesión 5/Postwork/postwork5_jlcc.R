...
#A partir del conjunto de datos de soccer de la liga española de 
#las temporadas 2017/2018, 2018/2019 y 2019/2020, crea el data frame 
...
#select del paquete dplyr. Luego establece un directorio de trabajo 
#y con ayuda de la función write.csv guarda el data frame como un 
#archivo csv con nombre soccer.csv. Puedes colocar 
...
#Con la función create.fbRanks.dataframes del paquete fbRanks importe 
#el archivo soccer.csv a R y al mismo tiempo asignelo a una variable 
#llamada listasoccer. Se creará una lista con los elementos scores y teams 
#que son data frames listos para la función rank.teams. Asigna estos 
...
#jugaron partidos. Crea una variable llamada n que contenga el número 
#de fechas diferentes. Posteriormente, con la función rank.teams y 
#usando como argumentos los data frames anotaciones y equipos, crea un 
#ranking de equipos usando unicamente datos desde la fecha inicial y hasta 
#la penúltima fecha en la que se jugaron partidos, estas fechas las deberá 
